...
export const metadata: Metadata = {
    ...
    description:
        "Terms and Conditions for Learn Wolof. Please read these terms carefully before using our service.",
};
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside space-y-2 mt-2">
                        ...
                        <li>
                            <strong>Country</strong> refers to: Senegal
                        </li>
                        <li>
                            <strong>Company</strong> (referred to as either "the Company",
                            "We", "Us" or "Our" in this Agreement) refers to Learn Wolof.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Website</strong> refers to Learn Wolof, accessible from{" "}
                            <a
                                href="https://learnwolof.com"
                                className="text-primary hover:underline"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://learnwolof.com
                            </a>
                        </li>
                        <li>
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside space-y-2 mt-2">
                        <li>
                            ...
                            <a
                                href="https://learnwolof.com/contact"
                                className="text-primary hover:underline"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://learnwolof.com/contact
                            </a>
                        </li>
                    </ul>
                </section>
